...
export default function ProfileInfo() {
  ...
  return (
    <div className="flex flex-col space-y-4 text-center">
      <div>
        <h1 className="text-4xl font-bold text-accent">{profile.name || "Add Your Name"}</h1>
      ...
      {((profile.showWalletAddress && walletAddress) || (profile.showBtcAddress && btcAddress)) && (
        <div className="space-y-2 mt-2">
          <div className="flex items-center justify-center mb-1">
            <h3 className="text-sm font-medium text-gray-300">Wallet Addresses</h3>
          </div>

          <div className="flex flex-col items-center space-y-2">
            {profile.showWalletAddress && walletAddress && (
              <div className="bg-background p-2 px-4 rounded-md flex items-center justify-between w-full max-w-sm border border-border">
                <div>
                ...
                <button 
                  className="text-accent hover:text-accent hover:opacity-80"

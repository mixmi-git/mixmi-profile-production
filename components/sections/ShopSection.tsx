      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {shopItems.map((item) => (
          <ShopCard 
            key={item.id} 
            item={item} 
            onEdit={isAuthenticated ? () => console.log('Edit shop item', item.id) : undefined}
          />
        ))}
        
        {isAuthenticated && shopItems.length < 6 && (
          <div 
            ...
            onClick={() => console.log('Add new shop item')}
          >
